...
/*Table structure for table `pic_content` */

DROP TABLE IF EXISTS `pic_content`;

CREATE TABLE `pic_content` (
  `id` int(11) NOT NULL COMMENT '图片id',
  `content` longblob COMMENT '图片的二进制表达',
  PRIMARY KEY (`id`),
  CONSTRAINT `pic_content_ibfk_1` FOREIGN KEY (`id`) REFERENCES `chart_info` (`chart_id`) ON DELETE CASCADE
