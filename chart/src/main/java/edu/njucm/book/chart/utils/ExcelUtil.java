...
public class ExcelUtil {
    ...
    public static String excelToHtml(InputStream in) {
        try{
            Workbook wb = WorkbookFactory.create(in);
            return getExcelInfo(wb,true);
        } catch (Exception e){
            e.printStackTrace();
    ...
    public static String getExcelInfo(Workbook wb,boolean isWithStyle) throws Exception{

        StringBuffer sb = new StringBuffer();
        Sheet sheet = wb.getSheetAt(2);//获取第一个Sheet的内容
    ...
    //borderStyles[0]设置 thin  防止 没加框线 table 内部显示不出线条
    private static String[] borderStyles={"thin","thin ","medium ","dashed ","dotted","thick",
            "double","hair ","medium_dashed","dash_dot","medium_dashed_dot","dash_dot_dot","medium_dash_dot_dot","slanted_dash_dot"};
    ...
    private static  String getBorderStyle(int b,short s, XSSFColor xc){
        ...
        if (xc != null && !"".equals(xc)) {
            ...
            borderColorStr=borderColorStr==null|| borderColorStr.length()<1?"#000000":borderColorStr.substring(2);//#000000
            return bordesr[b]+borderStyles[s]+borderColorStr+" 1px;";
        }
        return "";
    }
